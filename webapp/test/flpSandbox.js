		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#fabricammcrearempleado-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"fabricammcrearempleado-display": {
								"semanticObject": "fabricammcrearempleado",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=fabrica.mm.crearempleado",
									"url": sap.ui.require.toUrl("fabrica/mm/crearempleado")
								}
							}
						}
					}
